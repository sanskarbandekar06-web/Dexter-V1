...
import { Check, Trash2, Sparkles, BrainCircuit, ArrowUp, ArrowDown, Edit2, X, Flag, AlertCircle, Trash, Square, CheckSquare, Plus } from 'lucide-react';
...
const NotebookPage: React.FC<NotebookPageProps> = ({ isDarkMode, theme, tasks, setTasks, userId }) => {
                        ...
                        {task.isAI && (
                          <div className="flex items-center gap-2 mt-1.5">
                            <div className="px-2 py-0.5 bg-emerald-500/10 border border-emerald-500/20 rounded-md flex items-center gap-1.5">
                                ...
                                <span className="text-[9px] font-black uppercase tracking-widest text-emerald-500/80">AI Enhanced Intervention</span>
                            </div>
