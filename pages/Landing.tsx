...
const LandingPage: React.FC<LandingPageProps> = ({ theme, onLogin, onRegister, isDarkMode, onToggleTheme }) => {
    ...
    <div className={`min-h-screen ${theme.bg} ${theme.text} relative overflow-x-hidden selection:bg-orange-500/30`}>
      ...
      >
        ...
        <div className="flex-1 flex items-center justify-end gap-4">
          ...
          <button onClick={onLogin} className={`hidden md:flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm transition-all hover:bg-black/5 dark:hover:bg-white/5 ${theme.text}`}>
