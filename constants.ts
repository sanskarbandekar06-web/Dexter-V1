...
export const APP_THEMES: { light: ThemeColors; dark: ThemeColors } = {
  light: { 
    ...
    card: "bg-white border border-stone-100 shadow-xl shadow-stone-200/50 hover:shadow-2xl hover:shadow-stone-200/80 transition-all duration-500 rounded-[2rem]",
    cardBg: "bg-white", 
    cardBorder: "border-stone-100", 
    cardShadow: "shadow-lg", 
    navActive: "bg-stone-900 text-white shadow-lg shadow-stone-900/20", 
    navInactive: "text-stone-400 hover:bg-stone-100", 
    buttonPrimary: "bg-stone-900 text-white hover:bg-stone-800 shadow-lg shadow-stone-900/20", 
    buttonSecondary: "bg-white text-stone-900 border border-stone-200 hover:bg-stone-50", 
    chartFillStart: "#f59e0b", 
    chartStroke: "#d97706", 
    gradientRing: "text-orange-500", 
    sidebarBg: "bg-[#FDFBF7]", 
    sidebarBorder: "border-stone-200/60", 
    inputBg: "bg-white", 
  ...
  dark: { 
    ...
    card: "bg-[#151621] border border-white/5 shadow-2xl shadow-black/40 backdrop-blur-xl rounded-[2rem]",
    cardBg: "bg-[#151621]", 
    cardBorder: "border-white/5", 
    cardShadow: "shadow-none", 
    navActive: "bg-white text-black shadow-[0_0_20px_rgba(255,255,255,0.3)]", 
    navInactive: "text-gray-500 hover:bg-white/5", 
    buttonPrimary: "bg-white text-black hover:bg-gray-200 shadow-[0_0_25px_rgba(255,255,255,0.2)]", 
    buttonSecondary: "bg-white/5 text-white border border-white/10 hover:bg-white/10", 
    chartFillStart: "#818cf8", 
    chartStroke: "#6366f1", 
